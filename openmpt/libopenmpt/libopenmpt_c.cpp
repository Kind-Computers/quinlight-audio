...
size_t openmpt_module_read_interleaved_double_stereo( openmpt_module * mod, int32_t samplerate, size_t count, double * interleaved_stereo ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->read_interleaved_stereo( samplerate, count, interleaved_stereo );
	} catch ( ... ) {
...
double openmpt_module_get_current_channel_vu_mono( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
...
double openmpt_module_get_current_channel_vu_left( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
...
double openmpt_module_get_current_channel_vu_right( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
...
double openmpt_module_get_current_channel_vu_rear_left( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
...
double openmpt_module_get_current_channel_vu_rear_right( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
...
int32_t openmpt_module_get_sample_rate( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_rate( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int64_t openmpt_module_get_sample_length_frames( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_length_frames( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_channels( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_channels( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_c5_speed( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_c5_speed( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_relative_tone( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_relative_tone( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_fine_tune( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_fine_tune( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_default_volume( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_default_volume( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_has_sample_default_pan( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->has_sample_default_pan( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_default_pan( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_default_pan( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 128;
...
int32_t openmpt_module_get_instrument_keyboard_sample( openmpt_module * mod, int32_t instrument_index, int32_t note ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_instrument_keyboard_sample( instrument_index, note );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int64_t openmpt_module_read_sample_data( openmpt_module * mod, int32_t index, double * buffer, int64_t buffer_frames ) {
	try {
		openmpt::interface::check_soundfile( mod );
		openmpt::interface::check_pointer( buffer );
		return mod->impl->read_sample_data( index, buffer, buffer_frames );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_replace_sample_data( openmpt_module * mod, int32_t index, const double * data, int64_t length_frames, int32_t channels, int32_t new_sample_rate ) {
	try {
		openmpt::interface::check_soundfile( mod );
		openmpt::interface::check_pointer( data );
		return mod->impl->replace_sample_data( index, data, length_frames, channels, new_sample_rate );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_replace_sample_data_raw( openmpt_module * mod, int32_t index, const double * data, int64_t length_frames, int32_t channels, int32_t new_sample_rate ) {
	try {
		openmpt::interface::check_soundfile( mod );
		openmpt::interface::check_pointer( data );
		return mod->impl->replace_sample_data_raw( index, data, length_frames, channels, new_sample_rate );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_set_sample_loop_points( openmpt_module * mod, int32_t index, int64_t loop_start, int64_t loop_end, int32_t loop_mode, int64_t sustain_start, int64_t sustain_end, int32_t sustain_mode ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_sample_loop_points( index, loop_start, loop_end, loop_mode, sustain_start, sustain_end, sustain_mode );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_refresh_channels_for_sample( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->refresh_channels_for_sample( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_get_linear_slides( openmpt_module * mod ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_linear_slides();
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_set_linear_slides( openmpt_module * mod, int enabled ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_linear_slides( enabled != 0 );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_get_agc_enabled( openmpt_module * mod ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_agc_enabled();
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_set_agc_enabled( openmpt_module * mod, int enabled ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_agc_enabled( enabled != 0 );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_get_agc_profile( openmpt_module * mod ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_agc_profile();
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int openmpt_module_set_agc_profile( openmpt_module * mod, int profile ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_agc_profile( profile );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_set_test_preamp( openmpt_module * mod, int32_t preamp ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_test_preamp( preamp );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_set_pattern_row_channel_command( openmpt_module * mod, int32_t pattern, int32_t row, int32_t channel, int command, uint8_t value ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->set_pattern_row_channel_command( pattern, row, channel, command, value );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_has_sample_loop( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->has_sample_loop( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int64_t openmpt_module_get_sample_loop_start( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_loop_start( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int64_t openmpt_module_get_sample_loop_end( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_loop_end( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_loop_mode( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_loop_mode( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int openmpt_module_has_sample_sustain_loop( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->has_sample_sustain_loop( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int64_t openmpt_module_get_sample_sustain_loop_start( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_sustain_loop_start( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int64_t openmpt_module_get_sample_sustain_loop_end( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_sustain_loop_end( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_sustain_loop_mode( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_sustain_loop_mode( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_bits_per_sample( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_bits_per_sample( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return 0;
...
int32_t openmpt_module_get_sample_format( openmpt_module * mod, int32_t index ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_sample_format( index );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int32_t openmpt_module_get_current_channel_sample( openmpt_module * mod, int32_t channel ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->get_current_channel_sample( channel );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int64_t openmpt_module_save_to_memory( openmpt_module * mod, void * buffer, int64_t buffer_size ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->save_module_to_memory( buffer, buffer_size );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int64_t openmpt_module_save_loaded_format_to_memory( openmpt_module * mod, void * buffer, int64_t buffer_size ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->save_loaded_format_to_memory( buffer, buffer_size );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
int64_t openmpt_module_save_best_format_to_memory( openmpt_module * mod, void * buffer, int64_t buffer_size ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->save_best_format_to_memory( buffer, buffer_size );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
...
const char * openmpt_module_get_loaded_format_extension( openmpt_module * mod ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return openmpt::strdup( mod->impl->get_loaded_format_extension().c_str() );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return openmpt::strdup( "" );
...
const char * openmpt_module_get_best_save_format_extension( openmpt_module * mod ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return openmpt::strdup( mod->impl->get_best_save_format_extension().c_str() );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return openmpt::strdup( "" );
...
int64_t openmpt_module_save_render_snapshot_to_memory( openmpt_module * mod, void * buffer, int64_t buffer_size ) {
	try {
		openmpt::interface::check_soundfile( mod );
		return mod->impl->save_render_snapshot_to_memory( buffer, buffer_size );
	} catch ( ... ) {
		openmpt::report_exception( __func__, mod );
	}
	return -1;
